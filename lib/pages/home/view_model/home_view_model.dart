...
class HomeViewModel extends ChangeNotifier {
  ...
  String screensText = "nhấn để nói";
  bool isListening = false;

  void errorListener(SpeechRecognitionError error) {
    log('Received error status: $error, listening: ${speechToText.isListening}');
  }

  final FlutterTts flutterTts = FlutterTts();

  List<String> turnOnLight = ["Mở đèn", "open the light", "turn on light"];
